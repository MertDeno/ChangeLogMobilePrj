...
export interface MultiInputPropTypes extends MultiInputAttributes, Omit<CommonProps, 'onChange' | 'onInput'> {
     ...
     */
    onTokenDelete?: (event: Ui5CustomEvent<HTMLInputElement, {
        token: ReactNode;
    }>) => void;
    /**
     ...
     */
    onSuggestionItemPreview?: (event: Ui5CustomEvent<HTMLInputElement, {
        item: ReactNode;
        targetRef: ReactNode;
    }>) => void;
    /**
     ...
     */
    onSuggestionItemSelect?: (event: Ui5CustomEvent<HTMLInputElement, {
        item: ReactNode;
    }>) => void;
}
/**
