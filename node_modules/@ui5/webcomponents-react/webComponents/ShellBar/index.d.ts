...
export interface ShellBarPropTypes extends ShellBarAttributes, CommonProps {
     ...
     */
    onCoPilotClick?: (event: Ui5CustomEvent<HTMLElement, {
        targetRef: ReactNode;
    }>) => void;
    /**
     * Fired, when the logo is activated.
     */
    onLogoClick?: (event: Ui5CustomEvent<HTMLElement, {
        targetRef: ReactNode;
    }>) => void;
    /**
     * Fired, when a menu item is activated **Note:** You can prevent closing of oveflow popover by calling `event.preventDefault()`.
     */
    onMenuItemClick?: (event: Ui5CustomEvent<HTMLElement, {
        item: ReactNode;
    }>) => void;
    /**
     * Fired, when the notification icon is activated.
     */
    onNotificationsClick?: (event: Ui5CustomEvent<HTMLElement, {
        targetRef: ReactNode;
    }>) => void;
    /**
     ...
     */
    onProductSwitchClick?: (event: Ui5CustomEvent<HTMLElement, {
        targetRef: ReactNode;
    }>) => void;
    /**
     * Fired, when the profile slot is present.
     */
    onProfileClick?: (event: Ui5CustomEvent<HTMLElement, {
        targetRef: ReactNode;
    }>) => void;
}
/**
